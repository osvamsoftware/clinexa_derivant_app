...
import 'package:clinexa_derivant_app/presentation/patient_details/patient_details_screen.dart';
...
import 'package:clinexa_derivant_app/presentation/register_patient/patient_signature_screen.dart';
import 'package:clinexa_derivant_app/presentation/register_patient/patient_verification_screen.dart';
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // Patient Signature
      GoRoute(
        path: '/patient-signature',
        name: 'patient-signature',
        builder: (context, state) {
          final cubit = state.extra as PatientRegistrationCubit;
          return BlocProvider.value(
            value: cubit,
            child: const PatientSignatureScreen(),
          );
        },
      ),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return BlocProvider.value(
            value: cubit,
            child: const PatientVerificationScreen(),
          );
        },
      ),
      ...
      GoRoute(
        ...
        name: NotificationsScreen.path,
        builder: (context, state) => const NotificationsScreen(),
      ),
      GoRoute(
        path: NotificationDetailScreen.path,
        name: NotificationDetailScreen.path,
        builder: (context, state) {
      ...
      GoRoute(
        path: ContactProtocolScreen.path,
        name: ContactProtocolScreen.path,
        builder: (context, state) => const ContactProtocolScreen(),
      ),
      GoRoute(
      ...
      //patient details
      GoRoute(
        path: PatientDetailsScreen.path,
        name: PatientDetailsScreen.path,
        builder: (context, state) {
